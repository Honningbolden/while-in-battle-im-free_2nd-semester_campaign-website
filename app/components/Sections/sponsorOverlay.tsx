...
export default function SponsorOverlay() {
  ...
  return (
    <>
      <div onClick={openLink} className={`${styles.clippy} z-[200] overflow-hidden cursor-pointer ~@sm/5xl:~h-24/28 aspect-[74/20] absolute bottom-0 left-0 bg-primary-blue mix-blend-normal stroke-black stroke-2 hover:bg-blue-500 transition-colors`}>
