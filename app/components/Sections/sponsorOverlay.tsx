...
export default function SponsorOverlay({ toggleOpen }: SponsorOverlayProps) {
  ...
  return (
    <>
      <div onClick={toggleOpen} className={`${styles.clippy} z-[200] cursor-pointer h-[20vh] w-[74vh] absolute bottom-0 left-0 bg-blue-600 mix-blend-normal stroke-black stroke-2 hover:bg-blue-500 transition-colors`}>
